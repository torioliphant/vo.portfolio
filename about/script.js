...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const colors = {
    'Home': { highlight: '#FFFFFF', bg: '#4f4f4f' },
    'Explore': { highlight: '#fcf9ef', bg: '#4d4d4d' },
    'Digital': { highlight: '#C9B2B4', bg: '#4b4242' },
    'Physical': { highlight: '#E5BBC1', bg: '#675858' },
    'Sound': { highlight: '#8C8484', bg: '#524d4d' },
    'about me': { highlight: '#FAEBD7', bg: '#3d3b3b' },
    'featured work': { highlight: '#FAEBD7', bg: '#3d3b3b' }
  };



  const defaultBodyBg = '#3d3b3b';
