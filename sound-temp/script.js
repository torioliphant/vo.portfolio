...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const colors = {
    'Home': { highlight: '#FFFFFF', bg: '#8c8484' },
    'Explore': { highlight: '#fcf9ef', bg: '#8c8484' },
    'Digital': { highlight: '#C9B2B4', bg: '#8c8484' },
    'Physical': { highlight: '#E5BBC1', bg: '#8c8484' },
    'Sound': { highlight: '#8C8484', bg: '#8c8484' },
    'about me': { highlight: '#FAEBD7', bg: '#8c8484' },
    'featured work': { highlight: '#FAEBD7', bg: '#8c8484' }
  };



  const defaultBodyBg = '#8c8484';
