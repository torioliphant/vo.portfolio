...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const colors = {
    'Home': { highlight: '#FFFFFF', bg: '#e5bbc1' },
    'Explore': { highlight: '#fcf9ef', bg: '#e5bbc1' },
    'Digital': { highlight: '#C9B2B4', bg: '#e5bbc1' },
    'Physical': { highlight: '#E5BBC1', bg: '#e5bbc1' },
    'Sound': { highlight: '#8C8484', bg: '#e5bbc1' },
    'about me': { highlight: '#FAEBD7', bg: '#e5bbc1' },
    'featured work': { highlight: '#FAEBD7', bg: '#e5bbc1' }
  };



  const defaultBodyBg = '#e5bbc1';
