document.addEventListener('DOMContentLoaded', () => {
  ...
  const images = Array.from(track.querySelectorAll(':scope > img'));
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const colors = {
    'Home': { highlight: '#FFFFFF', bg: '#FFFFFF' },
    'Explore': { highlight: '#fcf9ef', bg: '#ffffff' },
    'Digital': { highlight: '#C9B2B4', bg: '#ede4e5' },
    'Physical': { highlight: '#E5BBC1', bg: '#fee5e8' },
    'Sound': { highlight: '#8C8484', bg: '#b9aeae' },
    'about me': { highlight: '#FAEBD7', bg: '#FFFFFF' },
    'featured work': { highlight: '#FAEBD7', bg: '#FFFFFF' }
  };



  const defaultBodyBg = '#ffffff';
